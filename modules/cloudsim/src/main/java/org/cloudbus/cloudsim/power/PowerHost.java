...
public class PowerHost extends HostDynamicWorkload {
	...
	public PowerHost(
		...
		super(id, temperature, ramProvisioner, bwProvisioner, storage, peList, vmScheduler);
	...
	public PowerHost clone()
	{
		PowerHost host = new PowerHost(this.getId(),this.getTemperature(),this.getRamProvisioner(),
				this.getBwProvisioner(),this.getStorage(),this.getPeList(),this.getVmScheduler(),this.getPowerModel());
		return host;
	}
