 ...
 */
public class PowerVmAllocationPolicyHybrid extends PowerVmAllocationPolicyAbstract {
	 ...
	 * @param list the list
	 */
	public PowerVmAllocationPolicyHybrid(List<? extends Host> list, String name) {
		super(list, name);
	}
