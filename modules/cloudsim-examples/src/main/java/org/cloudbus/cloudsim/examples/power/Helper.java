...
//		public final static int VM_SIZE		= 2500; // 2.5 GB
		...
		int[] VM_MIPS	 = { 500, 500, 800, 1200, 1800,2000,2200 };
		int[] VM_PES	 = { 1, 1, 1, 1, 1, 1, 1 };
		int[] VM_RAM	 = { 1800, 2000, 2000, 3200, 4000,4300,5000 };
		int[] VM_BW		 = {120000,150000,200000,300000,400000,500000,700000}; // 1 Gbit/s
		int VM_STORAGE = 100000; // 1 GB
		int VM_SIZE		= 2500; // 2.5 GB
		for (int i = 0; i < vmsNumber; i++) {
			//int vmType = i / (int) Math.ceil((double) vmsNumber / Constants.VM_TYPES);
			int vmType = (int)Math.floor(Math.random() * 7);
			vms.add(new PowerVm(
					i,
					brokerId,
					VM_MIPS[vmType],
	...
	public static List<PowerHost> createHostList(int hostsNumber) {
		...
		int[] HOST_MIPS	 = { 1860, 2060, 2460, 2660, 2960,3160,3560 };
		int[] HOST_PES	 = { 1, 1, 1, 1, 1, 1, 1 };
		int[] HOST_RAM	 = { 4096, 4096, 4096, 6144, 8192,8192,10240 };
		int HOST_BW		 = 1000000; // 1 Gbit/s
		int HOST_STORAGE = 1000000; // 1 GB
		for (int i = 0; i < hostsNumber; i++) {
			int hostType = (int)(Math.random() * 8) % 7;
	...
	public static void printResults(
		...
		if (outputInCsv) {
			...
			Log.print("The policy of " + datacenter.getPloicyName()+"  ");
